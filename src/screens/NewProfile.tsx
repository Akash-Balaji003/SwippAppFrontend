...
type NewProfileProps = NativeStackScreenProps<RootStackParamList, 'NewProfile'>;


const NewProfile = ({ navigation }: NewProfileProps) => {
    ...
    const [email1, setPrimay_email] = useState("");
    ...
    const storeCard = async() => {
        if (!cardTitle.trim() || !companyName.trim() || !primaryPhone.trim() || !email1.trim() || !cardAddress.trim() || !cardCity.trim() || !cardPincode.trim() || !cardCountry.trim()) {
